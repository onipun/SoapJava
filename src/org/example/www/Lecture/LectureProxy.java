...
public class LectureProxy implements org.example.www.Lecture.Lecture_PortType {
  ...
  public java.lang.String getItemCount(java.lang.String getItemCountRequest) throws java.rmi.RemoteException{
    if (lecture_PortType == null)
      _initLectureProxy();
    return lecture_PortType.getItemCount(getItemCountRequest);
  }
...
@Override
public void fnGetStudInfo(String text, StringHolder strStudName, StringHolder strStudGender, StringHolder strStudGroup,
		DateHolder studYearBirth, Holder<Float> fltStudCGPA) {
	// TODO Auto-generated method stub
...
@Override
public void fnGetStudInfo(String text, StringHolder strStudName, StringHolder strStudGender, StringHolder strStudGroup,
		DateHolder studYearBirth, StringHolder fltStudCGPA) {
	// TODO Auto-generated method stub
